...
import { lucideCircleCheck, lucideInfo, lucideLoader, lucideOctagonX, lucideTriangleAlert } from '@ng-icons/lucide';
...
@Component({
  ...
  template: `
    <ngx-sonner-toaster
      ...
      [dir]="dir()"
    >
      <ng-icon loading-icon name="lucideLoader" class="size-4 [&>svg]:animate-spin" />
  ...
  viewProviders: [provideIcons({ lucideCircleCheck, lucideInfo, lucideLoader, lucideOctagonX, lucideTriangleAlert })],
  host: {
    'data-slot': 'sonner',
  },
  exportAs: 'zSonner',
